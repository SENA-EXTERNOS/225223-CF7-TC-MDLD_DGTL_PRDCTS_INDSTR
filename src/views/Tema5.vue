  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 5
      h1 Aplicaciones de manufactura aditiva
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
      .row.justify-content-around.align-items-center(titulo="Sector automotiz")
        .col-md-6.mb-4.mb-md-0
          p En el sector automotriz o cualquier máquina que necesite de un motor, experimenta con agrado los beneficios de esta tecnología; como consecuencia están implementándolo en sus procesos de producción. Como resultado de ello tienen la posibilidad de imprimir de manera tridimensional tanto piezas tipo repuesto como también piezas nuevas y funcionales ahorrando dinero, tiempo y esfuerzo.
        .col-md-4
          figure
            img(src='@/assets/curso/temas/T5/img-2.png')
      ...
      .row.justify-content-around.align-items-center(titulo="Área aeroespacial ")
        ...
        .col-md-4
          figure
            img(src='@/assets/curso/temas/T5/img-3.png')
      ...
      .row.justify-content-around.align-items-center(titulo="Área médica ")
        .col-md-6.mb-4.mb-md-0
          p En el área médica la manufactura aditiva se ha dedicado a la implementación de la bio impresión con el fin de generar tejidos vivos, además de la fabricación de productos sanitarios que dan soporte a los médicos para algunos procedimientos.
      ...
      .row.justify-content-around.align-items-center(titulo="Alimentos y en los Instrumentos musicales")
        ...
        .col-md-4
          figure
            img(src='@/assets/curso/temas/T5/img-9.png')
